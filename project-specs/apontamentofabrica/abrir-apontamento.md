...
| `codEquipeAlocado` | string | Código alocado retornado pela abertura; no modo de reporte por operador pode conter o responsável mesmo quando `codOperadorAlocado` vier vazio. |
